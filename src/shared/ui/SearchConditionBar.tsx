...
function CalendarInput({ ariaLabel, type, value, onChange }: CalendarInputProps) {
        ...
        {inputType === 'dateRange' && (
          <>
            <label className="search-condition-bar__date">
              ...
              <CalendarInput ariaLabel={startDateLabel} type="date" value={startDate} onChange={setStartDate} />
            </label>
            <span className="search-condition-bar__dash">~</span>
            <label className="search-condition-bar__date">
              <span className="sr-only">{endDateLabel}</span>
              <CalendarInput ariaLabel={endDateLabel} type="date" value={endDate} onChange={setEndDate} />
            </label>
          </>
        )}
